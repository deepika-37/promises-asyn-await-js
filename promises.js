...
function myFirst() {function myDisplayer(some) {
...
setTimeout(()=>{
    heading1.textContent="deepika";
    heading1.style.color="blue"

setTimeout(()=>{
    heading2.textContent="tinku";
    heading2.style.color="orange"

setTimeout(()=>{
    heading3.textContent="rannu";
    heading3.style.color="navyblue"

setTimeout(()=>{
    heading4.textContent="rohitha";
    heading4.style.color="golden"

setTimeout(()=>{
    heading5.textContent="vignesh";
